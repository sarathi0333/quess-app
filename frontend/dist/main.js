...
var AppRoutes = [
    ...
    { path: 'admin', component: _components_adminpanel_adminpanel_component__WEBPACK_IMPORTED_MODULE_2__["AdminpanelComponent"], canActivate: [_auth_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]] },
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.onSubmit = function (phoneNumber) {
        var _this = this;
        this.networkservice.postMessage('./api/user', { phoneNumber: phoneNumber })
...
var WelcomeComponent = /** @class */ (function () {
    function WelcomeComponent(scrollToTop, router) {
        this.scrollToTop = scrollToTop;
        this.router = router;
        this.languages = ["English", "தமிழ்", "മലയാളം", "తెలుగు"];
    }
    ...
    WelcomeComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_shared_scrollToTop_scroll_top_service__WEBPACK_IMPORTED_MODULE_1__["ScrollTopService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]])
    ], WelcomeComponent);
